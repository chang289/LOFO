...
var DateRangeValidatorService = (function () {
    ...
    DateRangeValidatorService.prototype.isMonthDisabledByDisableUntil = function (date, disableUntil) {
        return this.isInitializedDate(disableUntil) && this.getTimeInMilliseconds(date) <= this.getTimeInMilliseconds(disableUntil);
    };
    DateRangeValidatorService.prototype.isMonthDisabledByDisableSince = function (date, disableSince) {
        return this.isInitializedDate(disableSince) && this.getTimeInMilliseconds(date) >= this.getTimeInMilliseconds(disableSince);
    };
    DateRangeValidatorService.prototype.isInitializedDate = function (date) {
    ...
    DateRangeValidatorService.decorators = [
        { type: _angular_core.Injectable },
    ];
    /** @nocollapse */
    DateRangeValidatorService.ctorParameters = [];
...
var MyDateRangePicker = (function () {
    function MyDateRangePicker(elem, renderer, dateRangeValidatorService) {
        var _this = this;
        this.elem = elem;
        this.renderer = renderer;
        this.dateRangeValidatorService = dateRangeValidatorService;
    ...
    MyDateRangePicker.prototype.userDateRangeInput = function (event) {
        ...
        if (event.target.value.length === 0) {
            ...
            var daterange = this.dateRangeValidatorService.isDateRangeValid(event.target.value, this.opts.dateFormat, this.opts.minYear, this.opts.maxYear, this.opts.disableUntil, this.opts.disableSince, this.opts.monthLabels);
    ...
    MyDateRangePicker.prototype.userMonthInput = function (event) {
        ...
        this.invalidMonth = false;
        var m = this.dateRangeValidatorService.isMonthLabelValid(event.target.value, this.opts.monthLabels);
        if (m !== -1) {
            this.editMonth = false;
    ...
    MyDateRangePicker.prototype.userYearInput = function (event) {
        ...
        this.invalidYear = false;
        var y = this.dateRangeValidatorService.isYearLabelValid(Number(event.target.value), this.opts.minYear, this.opts.maxYear);
        if (y !== -1) {
            this.editYear = false;
    ...
    MyDateRangePicker.prototype.getDateRangeModel = function (beginDate, endDate) {
        ...
        var bEpoc = this.getTimeInMilliseconds(beginDate) / 1000.0;
        var eEpoc = this.getTimeInMilliseconds(endDate) / 1000.0;
    ...
    MyDateRangePicker.ctorParameters = [
        { type: _angular_core.ElementRef, },
        { type: _angular_core.Renderer, },
        { type: DateRangeValidatorService, },
    ];
