...
import { IMyDate, IMyMonth, IMyOptions, IMyDateRangeModel, IMyInputFieldChanged, IMyCalendarViewChanged, IMyDateSelected } from "./interfaces/index";
...
export declare class MyDateRangePicker implements OnChanges, ControlValueAccessor {
    elem: ElementRef;
    private renderer;
    private dateRangeValidatorService;
    options: any;
    defaultMonth: string;
    selDateRange: string;
    placeholder: string;
    ...
    opts: IMyOptions;
    constructor(elem: ElementRef, renderer: Renderer, dateRangeValidatorService: DateRangeValidatorService);
