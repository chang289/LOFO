...
@NgModule({
  ...
  declarations: [ AppComponent, PipiComponent, MapComponent, APP_DECLARATION, HistoryComponent, myDateRangePickerDirective, MyDateRangePickerModule, EditComponent],
